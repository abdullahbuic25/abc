...
$name       = $_POST['name'];
$email      = $_POST['email'];
$subject    = isset($_POST['subject']) && !empty($_POST['subject']) ? $_POST['subject'] : 'A new message from Terapage contact form';
$content    = $_POST['content'];
$toMail     = 'Terapage <contact@terapage.ai>'; // Your name & mail address here example 'Your Name <contact@domain.com>'.
...
if ($error == true) {
	...
	$error   = false;
	$msg    .= '<strong>Success:</strong> Thanks for your message. Your message has been sent. We will get back to you.';
